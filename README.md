...
Library AI는 공연의 기획 → 제작 → 판매 전 단계의 데이터를 구조화하고 분석하여 데이터 기반 의사결정을 지원하는 시스템입니다.
...
8. Tailwind CSS 개발 모드 (별도 터미널): `python manage.py tailwind dev`

## 문서

- **[개발 가이드](docs/development-guide.md)**: 개발 환경 설정, 프로젝트 구조, 시스템 아키텍처, 데이터 관계, 개발 원칙
- **[디자인 시스템](docs/design-system.md)**: 컬러 시스템, 타이포그래피, 컴포넌트 가이드, 레이아웃 패턴
